...
!function (t, n) {
    ...
    const u = r(n), c = u.right, f = u.left, s = r(o).center;
    var l = c;
    const h = p(v), d = p((function (t) {
        const n = v(t);
        return (t, e, r, i, o) => {
    ...
    const j = Math.sqrt(50), H = Math.sqrt(10), X = Math.sqrt(2);
    ...
    function V(t, n, e) {
        if (!((e = +e) > 0)) return [];
        if ((t = +t) === (n = +n)) return [t];
        const r = n < t, [i, o, a] = r ? G(n, t, e) : G(t, n, e);
        if (!(o >= i)) return [];
    ...
    function Z(t, n, e) {
        e = +e;
        const r = (n = +n) < (t = +t), i = r ? W(n, t, e) : W(t, n, e);
    ...
    function J() {
        ...
        function r(r) {
            ...
            var f = n(c), s = f[0], h = f[1], d = e(c, s, h);
            if (!Array.isArray(d)) {
                const t = h, e = +d;
                if (n === T && ([s, h] = K(s, h, e)), (d = V(s, h, e))[0] <= s && (a = W(s, h, e)), d[d.length - 1] >= h) if (t >= h && n === T) {
                    const t = W(s, h, e);
            ...
            if (isFinite(a)) {
                if (a > 0) for (i = 0; i < u; ++i) null != (o = c[i]) && s <= o && o <= h && _[Math.min(p, Math.floor((o - s) / a))].push(r[i]); else if (a < 0) for (i = 0; i < u; ++i) if (null != (o = c[i]) && s <= o && o <= h) {
    ...
    function yt(t) {
        ...
        for (var n = -1, e = et(t, vt), r = new Array(e); ++n < e;) for (var i, o = -1, a = r[n] = new Array(i); ++o < i;) a[o] = t[o][n];
        return r
    }
    ...
    function Nt(t, n) {
        var e = [], r = null, i = null, o = 6, a = 6, u = 3,
            ...
            s = 4 === t || 2 === t ? "x" : "y", l = 1 === t || 3 === t ? Mt : Tt;

        function h(h) {
            var d = null == r ? n.ticks ? n.ticks.apply(n, e) : n.domain() : r,
                p = null == i ? n.tickFormat ? n.tickFormat.apply(n, e) : xt : i, g = Math.max(o, 0) + u, y = n.range(),
                v = +y[0] + c, _ = +y[y.length - 1] + c, b = (n.bandwidth ? St : At)(n.copy(), c),
    ...
    Pt.prototype = Ct.prototype = {
        constructor: Pt, on: function (t, n) {
            var e, r = this._, i = zt(t + "", r), o = -1, a = i.length;
            if (!(arguments.length < 2)) {
                if (null != n && "function" != typeof n) throw new Error("invalid callback: " + n);
                for (; ++o < a;) if (e = (t = i[o]).type) r[e] = Dt(r[e], t.name, n); else if (null == n) for (e in r) r[e] = Dt(r[e], t.name, null);
                return this
            }
            for (; ++o < a;) if ((e = (t = i[o]).type) && (e = $t(r[e], t.name))) return e
        }, copy: function () {
            var t = {}, n = this._;
    ...
    var Rt = "http://www.w3.org/1999/xhtml", Ft = {
    ...
    Jt.prototype = {
        constructor: Jt, appendChild: function (t) {
    ...
    Vn.prototype = Wn.prototype = {
        constructor: Vn, select: function (t) {
            ...
            var e = n ? en : nn, r = this._parents, i = this._groups;
            "function" != typeof t && (t = tn(t));
            for (var o = i.length, a = new Array(o), u = new Array(o), c = new Array(o), f = 0; f < o; ++f) {
                var s = r[f], l = i[f], h = l.length, d = on(t.call(s, s && s.__data__, f, r)), p = d.length,
            ...
            var e = "function" == typeof t ? t : Ot(t), r = null == n ? qn : "function" == typeof n ? n : Yt(n);
            return this.select((function () {
    ...
    const Ze = Math.PI / 180, Ke = 180 / Math.PI, Qe = .96422, Je = .82521, tr = 4 / 29, nr = 6 / 29, er = 3 * nr * nr;

    function rr(t) {
        if (t instanceof or) return new or(t.l, t.a, t.b, t.opacity);
        if (t instanceof hr) return dr(t);
        t instanceof qe || (t = Re(t));
        var n, e, r = fr(t.r), i = fr(t.g), o = fr(t.b), a = ar((.2225045 * r + .7168786 * i + .0606169 * o) / 1);
    ...
    var pr = -.14861, gr = 1.78277, yr = -.29227, vr = -.90649, _r = 1.97294, br = _r * vr, mr = _r * gr,
        xr = gr * yr - vr * pr;

    function wr(t) {
        if (t instanceof Tr) return new Tr(t.h, t.s, t.l, t.opacity);
        t instanceof qe || (t = Re(t));
        var n = t.r / 255, e = t.g / 255, r = t.b / 255, i = (xr * r + br * n - mr * e) / (xr + br - mr), o = r - i,
            a = (_r * (e - i) - yr * o) / vr, u = Math.sqrt(a * a + o * o) / (_r * i * (1 - i)),
    ...
    var $r = function t(n) {
        ...
        function r(t, n) {
            var r = e((t = Fe(t)).r, (n = Fe(n)).r), i = e(t.g, n.g), o = e(t.b, n.b), a = zr(t.opacity, n.opacity);
            return function (n) {
    ...
    var Lr = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, jr = new RegExp(Lr.source, "g");

    function Hr(t, n) {
        var e, r, i, o = Lr.lastIndex = jr.lastIndex = 0, a = -1, u = [], c = [];
    ...
    var Vr, Wr = 180 / Math.PI, Zr = {translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1};
        ...
        function i(t, i) {
            ...
            if (g < 1e-12) a = Math.log(h / f) / n, o = function (t) {
                ...
                a = (m - b) / n, o = function (t) {
                    var r = t * a, i = ni(b), o = f / (e * y) * (i * function (t) {
    ...
    function ri(t) {
        return function (n, e) {
            var r = t((n = He(n)).h, (e = He(e)).h), i = zr(n.s, e.s), o = zr(n.l, e.l), a = zr(n.opacity, e.opacity);
            return function (t) {
    ...
    var ii = ri(Cr), oi = ri(zr);

    function ai(t) {
        return function (n, e) {
            var r = t((n = lr(n)).h, (e = lr(e)).h), i = zr(n.c, e.c), o = zr(n.l, e.l), a = zr(n.opacity, e.opacity);
            return function (t) {
    ...
    var ui = ai(Cr), ci = ai(zr);

    function fi(t) {
        return function n(e) {
            function r(n, r) {
                var i = t((n = Mr(n)).h, (r = Mr(r)).h), o = zr(n.s, r.s), a = zr(n.l, r.l),
    ...
    var di, pi, gi = 0, yi = 0, vi = 0, _i = 0, bi = 0, mi = 0,
    ...
    Ai.prototype = Si.prototype = {
        constructor: Ai, restart: function (t, n, e) {
    ...
    var zi = Ct("start", "end", "cancel", "interrupt"), $i = [];
    ...
    ho.prototype = po.prototype = {
        ...
        transition: function () {
            for (var t = this._name, n = this._id, e = go(), r = this._groups, i = r.length, o = 0; o < i; ++o) for (var a, u = r[o], c = u.length, f = 0; f < c; ++f) if (a = u[f]) {
                var s = qi(a, n);
        ...
        attr: function (t, n) {
            var e = qt(t), r = "transform" === e ? ti : Yi;
        ...
        style: function (t, n, e) {
            ...
            return null == n ? this.styleTween(t, function (t, n) {
                var e, r, i;
                return function () {
                    var o = vn(this, t), a = (this.style.removeProperty(t), vn(this, t));
                    return o === a ? null : o === e && a === r ? i : i = n(e = o, r = a)
                }
            }(t, r)).on("end.style." + t, ao(t)) : "function" == typeof n ? this.styleTween(t, function (t, n, e) {
                var r, i, o;
                return function () {
                    var a = vn(this, t), u = e(this), c = u + "";
                ...
                return function () {
                    var c = Fi(this, t), f = c.on, s = null == c.value[a] ? o || (o = ao(n)) : void 0;
    ...
    var Po = 1.70158, zo = function t(n) {
        function e(t) {
        ...
        return n = +n, e.overshoot = t, e
    }(Po), Ro = 2 * Math.PI, Fo = function t(n, e) {
    ...
    }(1, .3), Io = {time: null, delay: 0, duration: 250, ease: _o};
    ...
    Wn.prototype.interrupt = function (t) {
        ...
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o) for (var a, u = r[o], c = u.length, f = 0; f < c; ++f) (a = u[f]) && Di(a, t, n, f, u, e || Oo(a, n));
    ...
    var Xo = {name: "drag"}, Go = {name: "space"}, Vo = {name: "handle"}, Wo = {name: "center"};
    const {abs: Zo, max: Ko, min: Qo} = Math;
    ...
    var na = {
            name: "x", handles: ["w", "e"].map(fa), input: function (t, n) {
            ...
            name: "xy", handles: ["n", "w", "e", "s", "nw", "ne", "sw", "se"].map(fa), input: function (t) {
            ...
            se: "nwse-resize",
            sw: "nesw-resize"
        }, oa = {e: "w", w: "e", nw: "ne", ne: "nw", se: "sw", sw: "se"},
        aa = {n: "s", s: "n", nw: "sw", ne: "se", se: "ne", sw: "nw"},
        ua = {overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1},
        ca = {overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1};
    ...
    function ga(t) {
        var n, e = la, r = sa, i = ha, o = !0, a = Ct("start", "brush", "end"), u = 6;
        ...
        function f() {
            var t = Zn(this), n = da(this).selection;
        ...
        function h(e) {
            if ((!n || e.touches) && r.apply(this, arguments)) {
                var i, a, u, c, l, h, d, p, g, y, v, _ = this, b = e.target.__data__.type,
                    ...
                    x = t === ea ? null : ua[b], w = t === na ? null : ca[b], M = da(_), T = M.extent, A = M.selection,
                ...
                if ("overlay" === b) {
                    A && (g = !0);
                    const n = [$[0], $[1] || $[0]];
                    M.selection = A = [[i = t === ea ? S : Qo(n[0][0], n[1][0]), u = t === na ? E : Qo(n[0][1], n[1][1])], [l = t === ea ? N : Ko(n[0][0], n[1][0]), d = t === na ? k : Ko(n[0][1], n[1][1])]], $.length > 1 && I(e)
                } else i = A[0][0], u = A[0][1], l = A[1][0], d = A[1][1];
                a = i, c = u, h = l, p = d;
                var R = Zn(_).attr("pointer-events", "none"), F = R.selectAll(".overlay").attr("cursor", ia[b]);
            ...
            function I(t) {
                ...
                h < a && (x *= -1, r = i, i = l, l = r, r = a, a = h, h = r, b in oa && F.attr("cursor", ia[b = oa[b]])), p < c && (w *= -1, r = u, u = d, d = r, r = c, c = p, p = r, b in aa && F.attr("cursor", ia[b = aa[b]])), M.selection && (A = M.selection), y && (a = A[0][0], h = A[1][0]), v && (c = A[0][1], p = A[1][1]), A[0][0] === a && A[0][1] === c && A[1][0] === h && A[1][1] === p || (M.selection = [[a, c], [h, p]], f.call(_), D.brush(t, m.name))
            }
        ...
        return c.move = function (n, e, r) {
            n.tween ? n.on("start.brush", (function (t) {
                ...
                var n = this, r = n.__brush, i = s(n, arguments), o = r.selection,
                    a = t.input("function" == typeof e ? e.apply(this, arguments) : e, r.extent), u = Xr(o, a);
    ...
    var ya = Math.abs, va = Math.cos, _a = Math.sin, ba = Math.PI, ma = ba / 2, xa = 2 * ba, wa = Math.max, Ma = 1e-12;
    ...
    function Sa(t, n) {
        ...
        function a(a) {
            var u, c = a.length, f = new Array(c), s = Ta(0, c), l = new Array(c * c), h = new Array(c), d = 0;
    ...
    const Ea = Math.PI, Na = 2 * Ea, ka = 1e-6, Ca = Na - ka;
    ...
    let za = class {
        ...
        arcTo(t, n, e, r, i) {
            ...
            if (null === this._x1) this._append`M${this._x1 = t},${this._y1 = n}`; else if (l > ka) if (Math.abs(s * u - c * f) > ka && i) {
                let h = e - o, d = r - a, p = u * u + c * c, g = h * h + d * d, y = Math.sqrt(p), v = Math.sqrt(l),
                    _ = i * Math.tan((Ea - Math.acos((p + l - g) / (2 * y * v))) / 2), b = _ / v, m = _ / y;
    ...
    function La(t) {
        var n = Fa, e = qa, r = Ua, i = Ua, o = Ia, a = Oa, u = Ba, c = null;

        function f() {
            var f, s = n.apply(this, arguments), l = e.apply(this, arguments), h = u.apply(this, arguments) / 2,
                d = Da.call(arguments), p = +r.apply(this, (d[0] = s, d)), g = o.apply(this, d) - ma,
                y = a.apply(this, d) - ma, v = +i.apply(this, (d[0] = l, d)), _ = o.apply(this, d) - ma,
                b = a.apply(this, d) - ma;
            if (c || (c = f = $a()), h > Ma && (ya(y - g) > 2 * h + Ma ? y > g ? (g += h, y -= h) : (g -= h, y += h) : g = y = (g + y) / 2, ya(b - _) > 2 * h + Ma ? b > _ ? (_ += h, b -= h) : (_ -= h, b += h) : _ = b = (_ + b) / 2), c.moveTo(p * va(g), p * _a(g)), c.arc(0, 0, p, g, y), g !== _ || y !== b) if (t) {
    ...
    function Ga(t, n) {
        for (var e, r = -1, i = n.length; ++r < i;) if (e = Va(t, n[r])) return e;
        return 0
    }
    ...
    var Ka = [[], [[[1, 1.5], [.5, 1]]], [[[1.5, 1], [1, 1.5]]], [[[1.5, 1], [.5, 1]]], [[[1, .5], [1.5, 1]]], [[[1, 1.5], [.5, 1]], [[1, .5], [1.5, 1]]], [[[1, .5], [1, 1.5]]], [[[1, .5], [.5, 1]]], [[[.5, 1], [1, .5]]], [[[1, 1.5], [1, .5]]], [[[.5, 1], [1, .5]], [[1.5, 1], [1, 1.5]]], [[[1.5, 1], [1, .5]]], [[[.5, 1], [1.5, 1]]], [[[1, 1.5], [1.5, 1]]], [[[.5, 1], [1, 1.5]]], []];
    ...
    function Qa() {
        ...
        function i(t) {
            var n = e(t);
            if (Array.isArray(n)) n = n.slice().sort(Ha); else {
                const e = T(t, Ja);
        ...
        function o(e, i) {
            ...
            return function (e, r, i) {
                ...
                for (var n, e = 0, r = u.length; e < r; ++e) if (-1 !== Ga((n = u[e])[0], t)) return void n.push(t)
        ...
        function u(e, r, i) {
            e.forEach((function (e) {
                var o = e[0], a = e[1], u = 0 | o, c = 0 | a, f = nu(r[c * t + u]);
    ...
    const fu = cu(4), su = cu(8), lu = cu(12), hu = cu(16), du = cu(4);

    function pu(t, n, e, r, i, o) {
        const a = (n - o) * (e - i), u = (t - i) * (r - o), c = a - u;
        ...
        return Math.abs(c) >= 33306690738754716e-32 * f ? c : -function (t, n, e, r, i, o, a) {
            ...
            let k = function (t, n) {
                ...
                return e
            }(4, fu), C = 22204460492503146e-32 * a;
            if (k >= C || -k >= C) return k;
    ...
    const gu = Math.pow(2, -52), yu = new Uint32Array(512);
    ...
    class vu {
        ...
        update() {
            ...
            for (let o, a, u = 0; u < this._ids.length; u++) {
                ...
                l = n[l];
                let g, y = l;
                for (; g = e[y], pu(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]) >= 0;) if (y = g, y === l) {
                    y = -1;
                    break
                }
                if (-1 === y) continue;
                ...
                if (y === l) for (; g = n[y], pu(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]) < 0;) v = this._addTriangle(g, c, y, -1, r[y], r[g]), this._legalize(v + 2), r[g] = v, e[y] = y, T--, y = g;
    ...
    class Nu {
        ...
        _init() {
            ...
            for (let n, r, o = 0, a = 0, u = e.length; o < u; o += 3, a += 2) {
                const u = 2 * e[o], c = 2 * e[o + 1], f = 2 * e[o + 2], s = t[u], l = t[u + 1], h = t[c], d = t[c + 1],
                    p = t[f], g = t[f + 1], y = h - s, v = d - l, _ = p - s, b = g - l, m = 2 * (y * b - v * _);
                if (Math.abs(m) < 1e-9) {
                    let i = 1e9;
                    const o = 2 * e[0];
                    i *= Math.sign((t[o] - s) * b - (t[o + 1] - l) * _), n = (s + p) / 2 - i * b, r = (l + g) / 2 + i * _
                } else {
                    const t = 1 / m, e = y * y + v * v, i = _ * _ + b * b;
        ...
        renderCell(t, n) {
            const e = null == n ? n = new Su : void 0, r = this._clip(t);
    ...
    const ku = 2 * Math.PI, Cu = Math.pow;
    ...
    class Du {
        ...
        * neighbors(t) {
        ...
        _step(t, n, e) {
            ...
            let f = t, s = Cu(n - c[2 * t], 2) + Cu(e - c[2 * t + 1], 2);
            const l = r[t];
            let h = l;
            do {
                let r = u[h];
        ...
        render(t) {
            const n = null == t ? t = new Su : void 0, {points: e, halfedges: r, triangles: i} = this;
        ...
        renderPoints(t, n) {
            ...
            const e = null == t ? t = new Su : void 0, {points: r} = this;
        ...
        renderHull(t) {
            const n = null == t ? t = new Su : void 0, {hull: e, points: r} = this, i = 2 * e[0], o = e.length;
            t.moveTo(r[i], r[i + 1]);
            for (let n = 1; n < o; ++n) {
                const i = 2 * e[n];
                t.lineTo(r[i], r[i + 1])
        ...
        renderTriangle(t, n) {
            const e = null == n ? n = new Su : void 0, {points: r, triangles: i} = this, o = 2 * i[t *= 3],
                a = 2 * i[t + 1], u = 2 * i[t + 2];
    ...
    function Bu(t) {
        ...
        function r(t, n) {
            ...
            for (10 === t.charCodeAt(o - 1) && --o, 13 === t.charCodeAt(o - 1) && --o; (r = s()) !== Fu;) {
    ...
    var Yu = Bu(","), Lu = Yu.parse, ju = Yu.parseRows, Hu = Yu.format, Xu = Yu.formatBody, Gu = Yu.formatRows,
        Vu = Yu.formatRow, Wu = Yu.formatValue, Zu = Bu("\t"), Ku = Zu.parse, Qu = Zu.parseRows, Ju = Zu.format,
        tc = Zu.formatBody, nc = Zu.formatRows, ec = Zu.formatRow, rc = Zu.formatValue;
    ...
    var pc = dc("application/xml"), gc = dc("text/html"), yc = dc("image/svg+xml");
    ...
    Tc.copy = function () {
        var t, n, e = new wc(this._x, this._y, this._x0, this._y0, this._x1, this._y1), r = this._root;
        if (!r) return e;
        ...
        for (g && p.push(new _c(g, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); c = p.pop();) if (!(!(g = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l)) if (g.length) {
            var y = (i + a) / 2, v = (o + u) / 2;
        ...
        for (c && u.push(new _c(c, this._x0, this._y0, this._x1, this._y1)); n = u.pop();) if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && c.length) {
            var f = (r + o) / 2, s = (i + a) / 2;
    ...
    var Yc = {
        ...
        s: function (t, n) {
            var e = Rc(t, n);
            if (!e) return t + "";
            var r = e[0], i = e[1], o = i - (qc = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1, a = r.length;
    ...
    function Gc(t) {
        var n, e,
            r = void 0 === t.grouping || void 0 === t.thousands ? Lc : (n = Hc.call(t.grouping, Number), e = t.thousands + "", function (t, r) {
        ...
        function l(t) {
            var n = (t = Ic(t)).fill, e = t.align, l = t.sign, h = t.symbol, d = t.zero, p = t.width, g = t.comma,
            ...
            var b = "$" === h ? i : "#" === h && /[boxX]/.test(_) ? "0" + _.toLowerCase() : "",
                m = "$" === h ? o : /[%p]/.test(_) ? c : "", x = Yc[_], w = /[defgprs%]/.test(_);
            ...
            function M(t) {
                ...
                if ("c" === _) M = x(t) + M, t = ""; else {
                    ...
                    }(t)), T && 0 == +t && "+" !== l && (T = !1), h = (T ? "(" === l ? l : f : "-" === l || "(" === l ? "" : l) + h, M = ("s" === _ ? Xc[8 + qc / 3] : "") + M + (T && "(" === l ? ")" : ""), w) for (i = -1, o = t.length; ++i < o;) if (48 > (c = t.charCodeAt(i)) || c > 57) {
        ...
        return {
            format: l, formatPrefix: function (t, n) {
                var e = l(((t = Ic(t)).type = "f", t)), r = 3 * Math.max(-8, Math.min(8, Math.floor(Fc(n) / 3))),
                    i = Math.pow(10, -r), o = Xc[8 + r / 3];
                return function (t) {
                    return e(i * t) + o
                }
            }
    ...
    t.format = void 0, t.formatPrefix = void 0, Vc({thousands: ",", grouping: [3], currency: ["$", ""]});
    var Qc = 1e-6, Jc = 1e-12, tf = Math.PI, nf = tf / 2, ef = tf / 4, rf = 2 * tf, of = 180 / tf, af = tf / 180,
        uf = Math.abs, cf = Math.atan, ff = Math.atan2, sf = Math.cos, lf = Math.ceil, hf = Math.exp, df = Math.hypot,
        pf = Math.log, gf = Math.pow, yf = Math.sin, vf = Math.sign || function (t) {
            return t > 0 ? 1 : t < 0 ? -1 : 0
        }, _f = Math.sqrt, bf = Math.tan;
    ...
    var Cf, Pf, zf, $f, Df, Rf, Ff, qf, Uf, If, Of, Bf, Yf, Lf, jf, Hf, Xf = new A, Gf = new A, Vf = {
        point: Mf, lineStart: Mf, lineEnd: Mf, polygonStart: function () {
    ...
    function Qf(t, n) {
        var e = (t *= af) - zf, r = e >= 0 ? 1 : -1, i = r * e, o = sf(n = (n *= af) / 2 + ef), a = yf(n), u = Df * a,
            c = $f * o + u * sf(i), f = u * r * yf(i);
    ...
    var as, us, cs, fs, ss, ls, hs, ds, ps, gs, ys, vs, _s, bs, ms, xs, ws = {
        point: Ms, lineStart: As, lineEnd: Ss, polygonStart: function () {
    ...
    function Ts(t, n) {
        var e = ts([t * af, n * af]);
        if (Yf) {
            var r = es(Yf, e), i = es([r[1], -r[0], 0], r);
            os(i), i = Jf(i);
            var o, a = t - If, u = a > 0 ? 1 : -1, c = i[0] * of * u, f = uf(a) > 180;
    ...
    var $s = {
        sphere: Mf, point: Ds, lineStart: Fs, lineEnd: Is, polygonStart: function () {
    ...
    function Us(t, n) {
        t *= af;
        var e = sf(n *= af), r = e * sf(t), i = e * yf(t), o = yf(n),
    ...
    function Ls(t, n) {
        t *= af;
        var e = sf(n *= af), r = e * sf(t), i = e * yf(t), o = yf(n), a = ms * o - xs * i, u = xs * r - bs * o,
            c = bs * i - ms * r, f = df(a, u, c), s = xf(f), l = f && -s / f;
    ...
    function Zs(t, n) {
        var e = sf(t), r = yf(t), i = sf(n), o = yf(n);

        function a(t, n) {
            var a = sf(n), u = sf(t) * a, c = yf(t) * a, f = yf(n), s = f * e + u * r;
            return [ff(c * i - s * o, u * e - f * r), xf(s * i + c * o)]
        }

        return a.invert = function (t, n) {
            var a = sf(n), u = sf(t) * a, c = yf(t) * a, f = yf(n), s = f * i - c * o;
    ...
    function al(t, n) {
        var e = ol(n), r = n[1], i = yf(r), o = [yf(e), -sf(e), 0], a = 0, u = 0, c = new A;
        1 === i ? r = nf + Qc : -1 === i && (r = -nf - Qc);
        for (var f = 0, s = t.length; f < s; ++f) if (h = (l = t[f]).length) for (var l, h, d = l[h - 1], p = ol(d), g = d[1] / 2 + ef, y = yf(g), v = sf(g), _ = 0; _ < h; ++_, p = m, y = w, v = M, d = b) {
            var b = l[_], m = ol(b), x = b[1] / 2 + ef, w = yf(x), M = sf(x), T = m - p, S = T >= 0 ? 1 : -1, E = S * T,
                N = E > tf, k = y * w;
    ...
    function ul(t, n, e, r) {
        return function (i) {
            var o, a, u, c = n(i), f = tl(), s = n(f), l = !1, h = {
    ...
    var sl = ul((function () {
        ...
        var i;
        if (null == t) i = e * nf, r.point(-tf, i), r.point(0, i), r.point(tf, i), r.point(tf, 0), r.point(tf, -i), r.point(0, -i), r.point(-tf, -i), r.point(-tf, 0), r.point(-tf, i); else if (uf(t[0] - n[0]) > Qc) {
            var o = t[0] < n[0] ? tf : -tf;
    ...
    function ll(t) {
        var n = sf(t), e = 6 * af, r = n > 0, i = uf(n) > Qc;
        ...
        function a(t, e, r) {
            var i = [1, 0, 0], o = es(ts(t), ts(e)), a = ns(o, o), u = o[0], c = a - u * u;
            if (!c) return !r && t;
            var f = n * a / c, s = -n * u / c, l = es(i, o), h = is(i, f);
            rs(h, is(o, s));
            var d = l, p = ns(h, d), g = ns(d, d), y = p * p - g * (ns(h, h) - 1);
            if (!(y < 0)) {
                var v = _f(y), _ = is(d, (-p - v) / g);
                if (rs(_, h), _ = Jf(_), !r) return _;
                var b, m = t[0], x = e[0], w = t[1], M = e[1];
                x < m && (b = m, m = x, x = b);
                var T = x - m, A = uf(T - tf) < Qc;
        ...
        return ul(o, (function (t) {
            ...
            return {
                lineStart: function () {
                    ...
                    var d, p = [l, h], g = o(l, h), y = r ? g ? 0 : u(l, h) : g ? u(l + (l < 0 ? tf : -tf), h) : 0;
                    if (!n && (f = c = g) && t.lineStart(), g !== c && (!(d = a(n, p)) || nl(n, d) || nl(p, d)) && (p[2] = 1), g !== c) s = 0, g ? (t.lineStart(), d = a(p, n), t.point(d[0], d[1])) : (d = a(n, p), t.point(d[0], d[1], 2), t.lineEnd()), n = d; else if (i && n && r ^ g) {
                        var v;
    ...
    function _l(t, n, e, r) {
        ...
        return function (a) {
            var c, f, s, l, h, d, p, g, y, v, _, b = a, m = tl(), x = {
    ...
    var bl = {
        sphere: Mf, point: Mf, lineStart: function () {
            bl.point = xl, bl.lineEnd = ml
        }, lineEnd: Mf, polygonStart: Mf, polygonEnd: Mf
    };
    ...
    function wl(t, n) {
        t *= af;
        var e = yf(n *= af), r = sf(n), i = uf(t - dl), o = sf(i), a = r * yf(i), u = gl * e - pl * r * o,
            c = pl * e + gl * r * o;
    ...
    var Tl = [null, null], Al = {type: "LineString", coordinates: Tl};
    ...
    var El = {
        Feature: function (t, n) {
            ...
            for (var e = t.features, r = -1, i = e.length; ++r < i;) if (kl(e[r].geometry, n)) return !0;
            return !1
        }
    }, Nl = {
        Sphere: function () {
            ...
            for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) if (zl(e[r], n)) return !0;
            return !1
        }, GeometryCollection: function (t, n) {
            for (var e = t.geometries, r = -1, i = e.length; ++r < i;) if (kl(e[r], n)) return !0;
            return !1
        }
    };
    ...
    var Ul, Il, Ol, Bl, Yl = t => t, Ll = new A, jl = new A, Hl = {
        point: Mf, lineStart: Mf, lineEnd: Mf, polygonStart: function () {
    ...
    var Zl = Hl, Kl = 1 / 0, Ql = Kl, Jl = -Kl, th = Jl, nh = {
        point: function (t, n) {
            t < Kl && (Kl = t);
            t > Jl && (Jl = t);
            n < Ql && (Ql = n);
            n > th && (th = n)
        }, lineStart: Mf, lineEnd: Mf, polygonStart: Mf, polygonEnd: Mf, result: function () {
            var t = [[Kl, Ql], [Jl, th]];
            return Jl = th = -(Ql = Kl = 1 / 0), t
        }
    };
    var eh, rh, ih, oh, ah = nh, uh = 0, ch = 0, fh = 0, sh = 0, lh = 0, hh = 0, dh = 0, ph = 0, gh = 0, yh = {
        point: vh, lineStart: _h, lineEnd: xh, polygonStart: function () {
    ...
    function mh(t, n) {
        var e = t - ih, r = n - oh, i = _f(e * e + r * r);
    ...
    var Nh, kh, Ch, Ph, zh, $h = new A, Dh = {
        point: Mf, lineStart: function () {
            Dh.point = Rh
        }, lineEnd: function () {
    ...
    Hh.prototype = {
        constructor: Hh, point: function (t, n) {
    ...
    function Qh(t, n) {
        return +n ? function (t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
                ...
                if (b > 4 * n && g--) {
                    var m = a + h, x = u + d, w = c + p, M = _f(m * m + x * x + w * w), T = xf(w /= M),
                        A = uf(uf(w) - 1) < Qc || uf(o - l) < Qc ? (o + l) / 2 : ff(x, m), S = t(A, T), E = S[0],
    ...
    function td(t, n, e, r, i, o) {
        ...
        var a = sf(o), u = yf(o), c = a * t, f = u * t, s = a / t, l = u / t, h = (u * e - a * n) / t,
            d = (u * n + a * e) / t;
    ...
    function ed(t) {
        var n, e, r, i, o, a, u, c, f, s, l = 150, h = 480, d = 250, p = 0, g = 0, y = 0, v = 0, _ = 0, b = 0, m = 1,
            x = 1, w = null, M = sl, T = null, A = Yl, S = .5;
        ...
        function k() {
            var t = td(l, 0, 0, m, x, b).apply(null, n(p, g)), r = td(l, h - t[0], d - t[1], m, x, b);
        ...
        return E.stream = function (t) {
            ...
            return arguments.length ? (A = null == t ? (T = r = i = o = null, Yl) : _l(T = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]), C()) : null == T ? null : [[T, r], [i, o]]
        }, E.scale = function (t) {
    ...
    function cd(t) {
        return function (n, e) {
            var r = _f(n * n + e * e), i = t(r), o = yf(i), a = sf(i);
    ...
    function hd(t) {
        var n, e, r, i = nd(t), o = i.center, a = i.scale, u = i.translate, c = i.clipExtent, f = null;

        function s() {
            var o = tf * a(), u = i(Ks(i.rotate()).invert([0, 0]));
            return c(null == f ? [[u[0] - o, u[1] - o], [u[0] + o, u[1] + o]] : t === ld ? [[Math.max(u[0] - o, f), n], [Math.min(u[0] + o, e), r]] : [[f, Math.max(u[1] - o, n)], [e, Math.min(u[1] + o, r)]])
        }
    ...
    function pd(t, n) {
        var e = sf(t), r = t === n ? yf(t) : pf(e / sf(n)) / pf(dd(n) / dd(t)), i = e * gf(dd(t), r) / r;
        if (!r) return ld;
        ...
        return o.invert = function (t, n) {
            var e = i - n, o = vf(r) * _f(t * t + e * e), a = ff(t, uf(e)) * vf(e);
    ...
    function yd(t, n) {
        var e = sf(t), r = t === n ? yf(t) : (e - sf(n)) / (n - t), i = e / r + t;
    ...
    var vd = 1.340264, _d = -.081106, bd = 893e-6, md = .003796, xd = _f(3) / 2;

    function wd(t, n) {
        var e = xf(xd * yf(n)), r = e * e, i = r * r * r;
    ...
    function Hd(t, n) {
        var e, r;
        if (Vd(n, t)) return [n];
        for (e = 0; e < t.length; ++e) if (Xd(n, t[e]) && Vd(Zd(t[e], n), t)) return [t[e], n];
        for (e = 0; e < t.length - 1; ++e) for (r = e + 1; r < t.length; ++r) if (Xd(Zd(t[e], t[r]), n) && Xd(Zd(t[e], n), t[r]) && Xd(Zd(t[r], n), t[e]) && Vd(Kd(t[e], t[r], n), t)) return [t[e], t[r], n];
        throw new Error
    }
    ...
    function Vd(t, n) {
        for (var e = 0; e < n.length; ++e) if (!Gd(t, n[e])) return !1;
        return !0
    }
    ...
    function ep(t, n) {
        ...
        t:for (c = 3; c < o; ++c) {
            ...
            for (i.previous = e, i.next = r, e.next = r.previous = r = i, a = tp(e); (i = i.next) !== r;) (u = tp(i)) < a && (e = i, a = u);
            r = e.next
        }
    ...
    function op(t, n, e) {
        return function (r) {
            if (i = r.children) {
                ...
                if (a = ep(i, e), c) for (o = 0; o < u; ++o) i[o].r -= c;
                r.r = a + c
            }
        }
    }
    ...
    var Cp = Math.random, Pp = function t(n) {
        function e(t, e) {
        ...
        var e = Op.source(n), r = Yp.source(n);
        ...
        var e = Bp.source(n), r = Lp.source(n);
    ...
    function Jp() {
        var t, n, e = Qp().unknown(void 0), r = e.domain, i = e.range, o = 0, a = 1, u = !1, c = 0, f = 0, s = .5;
    ...
    function og(t, n, e) {
        ...
        return i < r ? (r = ig(i, r), o = e(a, o)) : (r = ig(r, i), o = e(o, a)), function (t) {
            return o(r(t))
        }
    }
    ...
    function cg() {
        var t, n, e, r, i, o, a = eg, u = eg, c = Xr, f = rg;
    ...
    function bg(n) {
        ...
        }, e.nice = () => r(hg(r(), {floor: t => o(Math.floor(i(t))), ceil: t => o(Math.ceil(i(t)))})), e
    }
    ...
    const Dg = $g.range, Rg = 1e3, Fg = 6e4, qg = 36e5, Ug = 864e5, Ig = 6048e5, Og = 2592e6, Bg = 31536e6,
        Yg = zg((t => {
            t.setTime(t - t.getMilliseconds())
        }), ((t, n) => {
            t.setTime(+t + n * Rg)
        }), ((t, n) => (n - t) / Rg), (t => t.getUTCSeconds())), Lg = Yg.range, jg = zg((t => {
            t.setTime(t - t.getMilliseconds() - t.getSeconds() * Rg)
        }), ((t, n) => {
            t.setTime(+t + n * Fg)
        }), ((t, n) => (n - t) / Fg), (t => t.getMinutes())), Hg = jg.range, Xg = zg((t => {
            t.setUTCSeconds(0, 0)
        }), ((t, n) => {
            t.setTime(+t + n * Fg)
        }), ((t, n) => (n - t) / Fg), (t => t.getUTCMinutes())), Gg = Xg.range, Vg = zg((t => {
            t.setTime(t - t.getMilliseconds() - t.getSeconds() * Rg - t.getMinutes() * Fg)
        }), ((t, n) => {
            t.setTime(+t + n * qg)
        }), ((t, n) => (n - t) / qg), (t => t.getHours())), Wg = Vg.range, Zg = zg((t => {
            t.setUTCMinutes(0, 0, 0)
        }), ((t, n) => {
            t.setTime(+t + n * qg)
        }), ((t, n) => (n - t) / qg), (t => t.getUTCHours())), Kg = Zg.range,
        ...
        }), ((t, n) => (n - t) / Ug), (t => t.getUTCDate() - 1)), ny = ty.range, ey = zg((t => {
            t.setUTCHours(0, 0, 0, 0)
        }), ((t, n) => {
            t.setUTCDate(t.getUTCDate() + n)
        }), ((t, n) => (n - t) / Ug), (t => Math.floor(t / Ug))), ry = ey.range;
    ...
    const oy = iy(0), ay = iy(1), uy = iy(2), cy = iy(3), fy = iy(4), sy = iy(5), ly = iy(6), hy = oy.range,
        dy = ay.range, py = uy.range, gy = cy.range, yy = fy.range, vy = sy.range, _y = ly.range;
    ...
    const my = by(0), xy = by(1), wy = by(2), My = by(3), Ty = by(4), Ay = by(5), Sy = by(6), Ey = my.range,
        Ny = xy.range, ky = wy.range, Cy = My.range, Py = Ty.range, zy = Ay.range, $y = Sy.range, Dy = zg((t => {
    ...
    function Yy(t, n, e, i, o, a) {
        const u = [[Yg, 1, Rg], [Yg, 5, 5e3], [Yg, 15, 15e3], [Yg, 30, 3e4], [a, 1, Fg], [a, 5, 3e5], [a, 15, 9e5], [a, 30, 18e5], [o, 1, qg], [o, 3, 108e5], [o, 6, 216e5], [o, 12, 432e5], [i, 1, Ug], [i, 2, 1728e5], [e, 1, Ig], [n, 1, Og], [n, 3, 7776e6], [t, 1, Bg]];
    ...
    function Zy(t) {
        var n = t.dateTime, e = t.date, r = t.time, i = t.periods, o = t.days, a = t.shortDays, u = t.months,
            c = t.shortMonths, f = iv(i), s = ov(i), l = iv(o), h = ov(o), d = iv(a), p = ov(a), g = iv(u), y = ov(u),
            v = iv(c), _ = ov(c), b = {
                a: function (t) {
                    return a[t.getDay()]
                }, A: function (t) {
                    ...
                    return u[t.getMonth()]
                }, c: null, d: Sv, e: Sv, f: Pv, g: Yv, G: jv, H: Ev, I: Nv, j: kv, L: Cv, m: zv, M: $v, p: function (t) {
                    return i[+(t.getHours() >= 12)]
                }, q: function (t) {
                    return 1 + ~~(t.getMonth() / 3)
                }, Q: d_, s: p_, S: Dv, u: Rv, U: Fv, V: Uv, w: Iv, W: Ov, x: null, X: null, y: Bv, Y: Lv, Z: Hv, "%": h_
            }, m = {
                a: function (t) {
                ...
                }, c: null, d: Xv, e: Xv, f: Kv, g: c_, G: s_, H: Gv, I: Vv, j: Wv, L: Zv, m: Qv, M: Jv, p: function (t) {
                    return i[+(t.getUTCHours() >= 12)]
                }, q: function (t) {
                    return 1 + ~~(t.getUTCMonth() / 3)
                }, Q: d_, s: p_, S: t_, u: n_, U: e_, V: i_, w: o_, W: a_, x: null, X: null, y: u_, Y: f_, Z: l_, "%": h_
            }, x = {
                a: function (t, n, e) {
                    ...
                    return T(t, n, e, r)
                }, d: yv, e: yv, f: wv, g: hv, G: lv, H: _v, I: _v, j: vv, L: xv, m: gv, M: bv, p: function (t, n, e) {
                    var r = f.exec(n.slice(e));
                    return r ? (t.p = s.get(r[0].toLowerCase()), e + r[0].length) : -1
                }, q: pv, Q: Tv, s: Av, S: mv, u: uv, U: cv, V: fv, w: av, W: sv, x: function (t, n, r) {
                    return T(t, e, n, r)
                }, X: function (t, n, e) {
                    return T(t, r, n, e)
                }, y: hv, Y: lv, Z: dv, "%": Mv
    ...
    var Ky, Qy = {"-": "", _: " ", 0: "0"}, Jy = /^\s*\d+/, tv = /^%/, nv = /[\\^$*+?|[\]().{}]/g;
    ...
    function M_(t, n, e, r, i, o, a, u, c, f) {
        var s = fg(), l = s.invert, h = s.domain, d = f(".%L"), p = f(":%S"), g = f("%I:%M"), y = f("%I %p"),
    ...
    function T_() {
        var t, n, e, r, i, o = 0, a = 1, u = rg, c = !1;
    ...
    function E_() {
        var t, n, e, r, i, o, a, u = 0, c = .5, f = 1, s = 1, l = rg, h = !1;
    ...
    var C_ = k_("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
        ...
        I_ = k_("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab"), O_ = t => Rr(t[t.length - 1]),
        ...
        Ob = O_(Ib);
    var Bb = li(Mr(300, .5, 0), Mr(-240, .5, 1)), Yb = li(Mr(-100, .75, .35), Mr(80, 1.5, .8)),
        Lb = li(Mr(260, .75, .35), Mr(80, 1.5, .8)), jb = Mr();
    var Hb = Fe(), Xb = Math.PI / 3, Gb = 2 * Math.PI / 3;
    ...
    const tm = Math.abs, nm = Math.atan2, em = Math.cos, rm = Math.max, im = Math.min, om = Math.sin, am = Math.sqrt,
        um = 1e-12, cm = Math.PI, fm = cm / 2, sm = 2 * cm;
    ...
    function mm(t, n, e, r, i, o, a) {
        var u = t - e, c = n - r, f = (a ? o : -o) / am(u * u + c * c), s = f * c, l = -f * u, h = t + s, d = n + l,
            p = e + s, g = r + l, y = (h + p) / 2, v = (d + g) / 2, _ = p - h, b = g - d, m = _ * _ + b * b, x = i - o,
            w = h * g - p * d, M = (b < 0 ? -1 : 1) * am(rm(0, x * x * m - w * w)), T = (w * b - _ * M) / m,
    ...
    function Em(t, n) {
        var e = Jb(!0), r = null, i = Tm, o = null, a = dm(u);

        function u(u) {
            var c, f, s, l = (u = wm(u)).length, h = !1;
    ...
    function Nm(t, n, e) {
        var r = null, i = Jb(!0), o = null, a = Tm, u = null, c = dm(f);

        function f(f) {
            var s, l, h, d, p, g = (f = wm(f)).length, y = !1, v = new Array(g), _ = new Array(g);
    ...
    function Fm() {
        var t = Nm().curve(Pm), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
    ...
    function Hm(t) {
        let n = Lm, e = jm, r = Am, i = Sm, o = null, a = null, u = dm(c);

        function c() {
            let c;
            const f = xm.call(arguments), s = n.apply(this, f), l = e.apply(this, f);
    ...
    var Gm = {
        draw(t, n) {
            const e = .59436 * am(n + im(n / 28, .75)), r = e / 2, i = r * Xm;
    ...
    const Zm = am(1 / 3), Km = 2 * Zm;
    var Qm = {
        draw(t, n) {
            const e = am(n / Km), r = e * Zm;
    ...
    const rx = om(cm / 10) / om(7 * cm / 10), ix = om(sm / 10) * rx, ox = -em(sm / 10) * rx;
    var ax = {
        draw(t, n) {
            const e = am(.8908130915292852 * n), r = ix * e, i = ox * e;
            t.moveTo(0, -e), t.lineTo(r, i);
            for (let n = 1; n < 5; ++n) {
                const o = sm * n / 5, a = em(o), u = om(o);
    ...
    var sx = {
        draw(t, n) {
            const e = .6824 * am(n), r = e / 2, i = e * fx / 2;
            t.moveTo(0, -e), t.lineTo(i, r), t.lineTo(-i, r), t.closePath()
        }
    };
    const lx = -.5, hx = am(3) / 2, dx = 1 / am(12), px = 3 * (dx / 2 + 1);
    var gx = {
        draw(t, n) {
            const e = am(n / px), r = e / 2, i = e * dx, o = r, a = e * dx + e, u = -o, c = a;
    ...
    const vx = [Vm, Wm, Qm, nx, ax, cx, gx], _x = [Vm, tx, yx, sx, Gm, ex, Jm];
    ...
    xx.prototype = {
        ...
        areaStart: bx, areaEnd: bx, lineStart: function () {
    ...
    Ox.prototype = {
        ...
        areaStart: function () {
            ...
            if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]); else for (var r = Wx(t), i = Wx(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
    ...
    function aw(t, {sourceEvent: n, target: e, transform: r, dispatch: i}) {
        Object.defineProperties(this, {
            type: {value: t, enumerable: !0, configurable: !0},
            sourceEvent: {value: n, enumerable: !0, configurable: !0},
            target: {value: e, enumerable: !0, configurable: !0},
    ...
    uw.prototype = {
        constructor: uw, scale: function (t) {
    ...
    function fw(t) {
        for (; !t.__zoom;) if (!(t = t.parentNode)) return cw;
        return t.__zoom
    }
    ...
    fw.prototype = uw.prototype, t.Adder = A, t.Delaunay = Du, t.FormatSpecifier = Oc, t.InternMap = InternMap, t.InternSet = InternSet, t.Node = qd, t.Path = za, t.Voronoi = Nu, t.ZoomTransform = uw, t.active = function (t, n) {
        ...
        if (i) for (r in n = null == n ? null : n + "", i) if ((e = i[r]).state > 1 && e.name === n) return new ho([[t]], Bo, n, +r);
        return null
    }, t.arc = function () {
        var t = pm, n = gm, e = Jb(0), r = null, i = ym, o = vm, a = _m, u = null, c = dm(f);

        function f() {
            var f, s, l = +t.apply(this, arguments), h = +n.apply(this, arguments), d = i.apply(this, arguments) - fm,
                p = o.apply(this, arguments) - fm, g = tm(p - d), y = p > d;
            if (u || (u = f = c()), h < l && (s = h, h = l, l = s), h > um) if (g > sm - um) u.moveTo(h * em(d), h * om(d)), u.arc(0, 0, h, d, p, !y), l > um && (u.moveTo(l * em(p), l * om(p)), u.arc(0, 0, l, p, d, y)); else {
                var v, _, b = d, m = p, x = d, w = p, M = g, T = g, A = a.apply(this, arguments) / 2,
                    S = A > um && (r ? +r.apply(this, arguments) : am(l * l + h * h)),
                    E = im(tm(h - l) / 2, +e.apply(this, arguments)), N = E, k = E;
                if (S > um) {
                    var C = hm(S / l * om(A)), P = hm(S / h * om(A));
                    (M -= 2 * C) > um ? (x += C *= y ? 1 : -1, w -= C) : (M = 0, x = w = (d + p) / 2), (T -= 2 * P) > um ? (b += P *= y ? 1 : -1, m -= P) : (T = 0, b = m = (d + p) / 2)
                }
                var z = h * em(b), $ = h * om(b), D = l * em(w), R = l * om(w);
                if (E > um) {
                    var F, q = h * em(m), U = h * om(m), I = l * em(x), O = l * om(x);
                    if (g < cm) if (F = bm(z, $, I, O, q, U, D, R)) {
                        var B = z - F[0], Y = $ - F[1], L = q - F[0], j = U - F[1],
        ...
        var t = ru, n = iu, e = ou, r = 960, i = 500, o = 20, a = 2, u = 3 * o, c = r + 2 * u >> a, f = i + 2 * u >> a,
            s = Xa(20);

        function l(r) {
            var i = new Float32Array(c * f), s = Math.pow(2, -a), l = -1;
            for (const o of r) {
                var d = (t(o, ++l, r) + u) * s, p = (n(o, l, r) + u) * s, g = +e(o, l, r);
        ...
        function d(t) {
            var n = l(t), e = s(n), r = Math.pow(2, 2 * a);
        ...
        return d.contours = function (t) {
            var n = l(t), e = Qa().size([c, f]), r = Math.pow(2, 2 * a), i = t => {
                t = +t;
        ...
        const n = "function" == typeof t[t.length - 1] && function (t) {
            return n => t(...n)
        }(t.pop()), e = (t = t.map(x)).map(b), r = t.length - 1, i = new Array(r + 1).fill(0), o = [];
        ...
        var t, n, e, r, i = se, o = le, a = he, u = de, c = {}, f = Ct("start", "drag", "end"), s = 0, l = 0;
        ...
        function a() {
            for (var t, a, c, f, s, l, h, d = n.length, p = 0; p < o; ++p) for (a = xc(n, Ec, Nc).visitAfter(u), t = 0; t < d; ++t) c = n[t], l = e[c.index], h = l * l, f = c.x + c.vx, s = c.y + c.vy, a.visit(g);
        ...
        var n, e, r, i, o, a, u = kc, c = function (t) {
            return 1 / Math.min(i[t.source.index], i[t.target.index])
        }, f = Ac(30), s = 1;

        function l(r) {
            for (var i = 0, u = t.length; i < s; ++i) for (var c, f, l, h, d, p, g, y = 0; y < u; ++y) f = (c = t[y]).source, h = (l = c.target).x + l.vx - f.x - f.vx || Sc(a), d = l.y + l.vy - f.y - f.vy || Sc(a), h *= p = ((p = Math.sqrt(h * h + d * d)) - e[y]) / p * r * n[y], d *= p, l.vx -= h * (g = o[y]), l.vy -= d * g, f.vx += h * (g = 1 - g), f.vy += d * g
        }
        ...
        function f(e) {
            var i, o = t.length, a = xc(t, zc, $c).visitAfter(l);
        ...
        var n, e = 1, r = .001, i = 1 - Math.pow(r, 1 / 300), o = 0, a = .6, u = new Map, c = Si(l),
            f = Ct("tick", "end"), s = function () {
                let t = 1;
        ...
        var t, n, e, r, i, o, a = ad(), u = od().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            c = od().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), f = {
                point: function (t, n) {
                    o = [t, n]
                }
            };
        ...
        function a() {
            var a = e.apply(this, arguments), u = r.apply(this, arguments) * af, c = i.apply(this, arguments) * af;
        ...
        var t, n, e, r, i, o, a, u = 1, c = 0, f = 0, s = 1, l = 1, h = 0, d = null, p = 1, g = 1, y = jh({
            point: function (t, n) {
                var e = b([t, n]);
        ...
        return b.invert = function (e) {
            ...
            return arguments.length ? (v = null == t ? (d = e = r = i = null, Yl) : _l(d = +t[0][0], e = +t[0][1], r = +t[1][0], i = +t[1][1]), _()) : null == d ? null : [[d, e], [r, i]]
        }, b.scale = function (t) {
        ...
        var e = t[0] * af, r = t[1] * af, i = n[0] * af, o = n[1] * af, a = sf(r), u = yf(r), c = sf(o), f = yf(o),
            s = a * sf(e), l = a * yf(e), h = c * sf(i), d = c * yf(i), p = 2 * xf(_f(wf(o - r) + a * c * wf(i - e))),
            g = yf(p), y = p ? function (t) {
                var n = yf(t *= p) / g, e = yf(p - t) / g, r = e * s + n * h, i = e * l + n * d, o = e * u + n * f;
        ...
        var t = hd(Ed), n = t.center, e = t.rotate;
        ...
        var e = zr((t = ir(t)).l, (n = ir(n)).l), r = zr(t.a, n.a), i = zr(t.b, n.b), o = zr(t.opacity, n.opacity);
        return function (n) {
        ...
        var t = Cm, n = km, e = null, r = Jb(0), i = Jb(sm), o = Jb(0);

        function a(a) {
            var u, c, f, s, l, h = (a = wm(a)).length, d = 0, p = new Array(h), g = new Array(h),
                y = +r.apply(this, arguments), v = Math.min(sm, Math.max(-sm, i.apply(this, arguments) - y)),
        ...
        var o = kp(r), a = kp(i), u = a[0] === o[0], c = a[a.length - 1] === o[o.length - 1], f = [];
        ...
        var t = Jb([]), n = Qx, e = Kx, r = Jx;

        function i(i) {
            var o, a, u = Array.from(t.apply(this, arguments), tw), c = u.length, f = -1;
        ...
        var n, e, r = t.length, i = t.map(iw), o = nw(t), a = 0, u = 0, c = [], f = [];
        ...
        var t = yp, n = 1, e = 1, r = null;

        function i(i) {
            var c = function (t) {
                for (var n, e, r, i, o, a = new xp(t, 0), u = [a]; n = u.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) u.push(e = n.children[i] = new xp(r[i], i)), e.parent = n;
        ...
        var t = Ap, n = !1, e = 1, r = 1, i = [0], o = Od, a = Od, u = Od, c = Od, f = Od;
        ...
        var t, n, e, r = hw, i = dw, o = vw, a = gw, u = yw, c = [0, 1 / 0], f = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]],
            s = 250, l = ei, h = Ct("start", "zoom", "end"), d = 500, p = 0, g = 10;

        function y(t) {
            t.property("__zoom", pw).on("wheel.zoom", M, {passive: !1}).on("mousedown.zoom", T).on("dblclick.zoom", A).filter(u).on("touchstart.zoom", S).on("touchmove.zoom", E).on("touchend.zoom touchcancel.zoom", N).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)")
        }
        ...
        function T(t, ...n) {
            if (!e && r.apply(this, arguments)) {
                var i = t.currentTarget, a = x(this, n, !0).event(t),
                    u = Zn(t.view).on("mousemove.zoom", h, !0).on("mouseup.zoom", d, !0), c = ne(t, i), s = t.clientX,
                    l = t.clientY;
        ...
        function N(t, ...r) {
            if (this.__zooming) {
                ...
                if (a.touch1 && !a.touch0 && (a.touch0 = a.touch1, delete a.touch1), a.touch0) a.touch0[1] = this.__zoom.invert(a.touch0[0]); else if (a.end(), 2 === a.taps && (o = ne(o, this), Math.hypot(n[0] - o[0], n[1] - o[1]) < g)) {
        ...
        return y.transform = function (t, n, e, r) {
            ...
            return arguments.length ? (i = "function" == typeof t ? t : ow([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), y) : i
